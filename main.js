    ...
    for (let i = 0; i < quizzesArray.length; i++) {
        ...
        if(myQuizzID !== null) {
            myQuizzesSpaceQuizzesListAddress.innerHTML += `
                <li class="quizz-box" onclick="renderizeQuizz(${quizzesArray[i].id})">
    ...
    switch(screenOption) {
        ...
        case "quizzCreatorTemplatePage4":
            BODYADDRESS.innerHTML = `
                ...
                <button onclick="renderizeQuizz(quizzesArray[50])" class="red-button margin-bottom-0 red-button-final-creation-page"><h1>Acessar Quizz<h1></button>
...
function renderize2QuizzCreator4() {
    ...
    quizzInfoTitleAddress.insertAdjacentHTML('afterend', `
        <li class="quizz-box margin-bottom-0" onclick="renderizeQuizz(${quizzesArray[50].id})">
